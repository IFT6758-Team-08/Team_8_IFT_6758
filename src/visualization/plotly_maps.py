...
fig.update_xaxes(range=[-42, 43], title_text='Distance from the center of the rink(ft)')
fig.update_yaxes(range=[100,-11],title_text='Distance from the goal line(ft)')
